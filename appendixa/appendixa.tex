...
\begin{table}[h]
\centering
\caption{A table of stakes showing what is recorded during the dispute process up to the point where the `change' side has received enough support of 600 total tokens staked.}
...
\begin{table}[h]
\centering
\caption{A table of stakes showing what is recorded during the dispute process up to the point where both the `change' and `keep' sides have received 600 tokens of support.}
