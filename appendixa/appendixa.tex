...
We also assume that all users have the appropriate amount reputation to lose (i.e. A, B and C did not lose reputation between the time of backing this proposal and the resolution of the dispute). There are four transfers of reputation that must occur here:
