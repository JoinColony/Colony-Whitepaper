...
\[
 A \stackrel{!}{=} 3 R_M
\]
where $R_M$ is the mining reward. $A$ (and thus $R_M$) is calculated on a one-month moving average. It's value is submitted by us as an oracle ... at least at first... because how would we do that on-chain?
