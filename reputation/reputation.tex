...
In the case of the evaluator, a rating of 1 point counts as them rejecting the work and a score of 2-3 points counts as accepting the work. The rating received defines the reputation change the user will experience:
\begin{itemize}
...
\begin{equation*}
  ...
  \begin{cases}
    ...
    \ascode{parents}\left[\cdots\right] &	\parbox[t]{.6\linewidth}{\textnormal{array of \ascode{rep\_id}s of a \textit{logarithmic subset} of parent skills, where \ascode{parents[i]} gives the $2^i$-th parent}}\\
