...
Colony aims to be broadly meritocratic. Consequently, the majority of decisions in a colony are weighted by the relevant reputation. Unlike tokens, reputation cannot be transferred between addresses, %\footnote{If an address holding reputation is a contract, rather than an externally-owned account, then \emph{control} of that reputation may be passed between parties.}
