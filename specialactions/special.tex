...
Just as a member may stake only 10\% of the required amount and wait for further suppor from their peers (Section \ref{sec:costs-of-disputes}), with the difference being that without any third part support, this `objection' would never be processed on-chain.
