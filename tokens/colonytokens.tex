...
One of the chief benefits of a colony having its own token is that it can offer rewards for work before it has any revenue or external funding to draw on. %Similar perhaps to how a start-up company may promise stock options,
