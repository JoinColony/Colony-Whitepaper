...
\begin{figure}[h]
 ...
 \begin{tikzpicture}
   ...
   \node[ellipse,draw, dashed] at (0,-2) (engineering) {Engineering};
   ...
   \node[ellipse,draw, dashed] at (1.5,-4) (backend) {Backend}
    ...
    (tld.-90) edge[->, out=-60, in=120] (engineering.north)
    (tld.-60) edge[->, bend left=45, out=-60, in=120] (product.north)
    (engineering.-120) edge[->, bend left=45, in=-120] (frontend.north)
    (engineering.-60)  edge[->, bend left=45, out=-60, in=120] (backend.north);
 \end{tikzpicture}
