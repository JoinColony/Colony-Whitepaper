...
In order to create a task, the manager must possess sufficient reputation and must stake a number of the colony's own tokens proportional to the amount of reputation within the domain. This stake is used to discourage spam, and provide a mechanism whereby the manager can be punished for bad behaviour.
