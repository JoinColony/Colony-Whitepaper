...
In order to create a task, the manager must stake some number of Colony Tokens. This (small) stake is used to help discourage spamming of nonsense tasks, and provide a mechanism whereby the manager can be punished upon bad behaviour. 
