...
\newcommand\watermark[1]{%
    ...
    \parbox{10em}{% Allow line breaks
            \color{black!90}%  
            This PDF was created for Jane Doe.
        }%
    }}}}%
}


\title{COLONY: A Protocol for Decentralised Organisations  \\
    \large v0.1\\}
\author{ Alex Rea, Aron Fischer, Jack du Rose}
\date{}
\def\code#1{\texttt{#1}}
...
\newpage
\input{./tokens/tokens.tex}
\newpage
\input{./structure/structure.tex}
\newpage
\input{./tokens/colonytokens.tex}
\newpage
\input{./reputation/reputation.tex}
\newpage
% \input{./voting/voting.tex}
% \newpage
\input{./reputation/mining.tex}
\newpage
\input{./finance/finance.tex}
\newpage
\input{./disputes/disputes.tex}
\newpage
\input{./finance/revenue.tex}
\newpage
\input{./specialactions/special.tex}
\newpage
