...
\newpage
\input{./src/colony/colonytokens.tex}
\newpage
\input{./src/colony/reputation.tex}
\newpage
\input{./src/colony/disputes.tex}
\newpage
\input{./src/colony/revenue.tex}
\newpage
\input{./src/colony/finance.tex}
\newpage
\input{./src/extensions/extensions.tex}
\newpage
\input{./src/extensions/special.tex}
\newpage
\input{./src/network/network.tex}
\newpage
\input{./src/network/tokens.tex}
\newpage
