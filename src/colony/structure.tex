...
The arbitration permission give accounts the ability to make domain-specific state changes, meant as a means of resolving disputes. This permission also gives permission to emit reputation penalties (but not reputation increases).
